...
const HomeScreen: React.FC<any> = ({ navigation }) => {
  ...
  const renderData = ({ item }: { item: Doctor }) => {
    const defaultFemaleImage = require('../theme/assets/images/femaledoctor.png');
  const defaultMaleImage = require('../theme/assets/images/doctors.png');
  const imageSource = item.imageUrl ? { uri: item.imageUrl } : (item?.gender === "Female" ? defaultFemaleImage : defaultMaleImage);
    return (
